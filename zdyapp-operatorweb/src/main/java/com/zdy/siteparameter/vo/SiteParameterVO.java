...
public class SiteParameterVO extends Page implements Serializable{
	...
	public SiteParameterVO(SiteParameterVO siteParameterVO){
		if(null != siteParameterVO){
				this.setId(siteParameterVO.getId());
				this.setParamName(siteParameterVO.getParamName());
				this.setParamValue(siteParameterVO.getParamValue());
				this.setParamComment(siteParameterVO.getParamComment());
				this.setRemark(siteParameterVO.getRemark());
				this.setCreateTime(siteParameterVO.getCreateTime());
				this.setOperTime(siteParameterVO.getOperTime());
				this.setCreateUser(siteParameterVO.getCreateUser());
				this.setRsrvStr1(siteParameterVO.getRsrvStr1());
				this.setRsrvStr2(siteParameterVO.getRsrvStr2());
				this.setRsrvStr3(siteParameterVO.getRsrvStr3());
				this.setRsrvStr4(siteParameterVO.getRsrvStr4());
				this.setRsrvStr5(siteParameterVO.getRsrvStr5());
				this.setRsrvStr6(siteParameterVO.getRsrvStr6());
		}
	}
	
	public SiteParameterVO(SiteParameter siteParameter){
