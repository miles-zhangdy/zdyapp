...
public class LinksVO extends Page implements Serializable{
	...
	public LinksVO(LinksVO linksVO){
		if(null != linksVO){
				this.setId(linksVO.getId());
				this.setLinkName(linksVO.getLinkName());
				this.setLinkAddr(linksVO.getLinkAddr());
				this.setDisplay(linksVO.getDisplay());
				this.setLinkType(linksVO.getLinkType());
				this.setLinkComment(linksVO.getLinkComment());
				this.setCreateUser(linksVO.getCreateUser());
				this.setCreateTime(linksVO.getCreateTime());
				this.setOperTime(linksVO.getOperTime());
				this.setOperUser(linksVO.getOperUser());
				this.setRsrvStr1(linksVO.getRsrvStr1());
				this.setRsrvStr2(linksVO.getRsrvStr2());
				this.setRsrvStr4(linksVO.getRsrvStr4());
				this.setRsrvStr3(linksVO.getRsrvStr3());
				this.setRsrvStr5(linksVO.getRsrvStr5());
				this.setRsrvStr6(linksVO.getRsrvStr6());
				this.setRsrvStr7(linksVO.getRsrvStr7());
				this.setRsrvStr8(linksVO.getRsrvStr8());
				this.setRsrvStr9(linksVO.getRsrvStr9());
				this.setRsrvStr0(linksVO.getRsrvStr0());
				this.setAttachId(linksVO.getAttachId());
		}
	}
	
	public LinksVO(Links links){
		if(null != links){
				this.id = links.getId();
